...
public class RentedProperties extends AppCompatActivity {
        ...
        if(priceArray == null) {
            ...
            lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    Intent in = new Intent(RentedProperties.this, ListingDetails.class);
    ...
    public void populateArrays() throws ExecutionException, InterruptedException {
        ...
        ArrayList<String> list = new getRentedPropertyInfo().execute(s.getEmail()).get();
    ...
    private class getRentedPropertyInfo extends AsyncTask<String, Integer, ArrayList<String>> {
        ...
        protected ArrayList<String> doInBackground(String... strings) {
            ...
            try {
                ...
                String link = "http://akari.alsolaim.com/Mobile_App_Scripts/getRentedPropertiesMobile.php";
